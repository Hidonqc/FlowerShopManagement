...
public class CustomerView {
	 private final Scanner scanner = new Scanner(System.in);
	    ...
	    public boolean showCustomerMenu(int customerId) throws SQLException {
	        ...
	        while (true) {
	            ...
	            switch (scanner.nextInt()) {
	                ...
	                case 4 -> {
	                    return false; // Thoát khỏi menu khách hàng
	                }
	    ...
	    private void showCustomerInfo() {
	        try {
	            ModelCustomer customer = customerService.getCustomerInfo(currentCustomerId);
	            if (customer != null) {
	                System.out.println("\n📝 THÔNG TIN CÁ NHÂN 📝");
